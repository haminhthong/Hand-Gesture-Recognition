"""Mô-đun phân loại cử chỉ tĩnh bằng luật hình học (Rule-based Baseline)."""
...
class RuleStaticBaseline:
    """Bộ nhận diện cử chỉ tĩnh dựa trên luật hình học khoảng cách và góc.

    Được sử dụng làm baseline đối chứng với mô hình Machine Learning
    và hỗ trợ chạy độc lập qua tùy chọn `--mode rules`.
    """
